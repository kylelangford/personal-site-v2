...
const pageData = {
  ...
  subtitle: 'Your homepage takes 5+ seconds to load on mobile. That\'s not a minor issue—it\'s costing you customers.',
  problem: `Slow sites lose visitors. Google measures Core Web Vitals (LCP, FID, CLS) and uses them for rankings. If your pages are slow, you're losing organic traffic AND paid traffic bounces before converting. Mobile users—60%+ of your traffic—feel it worst.`,
  businessCase: `Amazon found that every 100ms of latency cost them 1% in sales. Google found that 53% of mobile users abandon sites that take longer than 3 seconds to load. Your slow site isn't just annoying—it's a direct hit to revenue and SEO.`,
  symptoms: [
    'PageSpeed Insights scores below 50',
    'High bounce rates on mobile devices',
    'Users complain the site "feels slow"',
  ...
  whatWeDo: [
    {
      ...
      description: 'We measure what matters: LCP, FID, CLS, TTFB. Real user metrics, not just lab tests. We identify the specific bottlenecks.'
    },
    {
      title: 'Image Optimization',
      description: 'Modern formats (WebP, AVIF), proper sizing, lazy loading, CDN delivery. Often the biggest quick win.'
    },
    {
      title: 'JavaScript Optimization',
      description: 'Code splitting, tree shaking, deferred loading of non-critical scripts. We reduce what blocks the main thread.'
    },
    {
